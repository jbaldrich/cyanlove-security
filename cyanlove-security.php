 ...
 *
 * @wordpress-plugin
 * Plugin Name:  Cyan Love Security
 * Plugin URI:   https://cyanlove.com/security/
 * Description:  Follow the WordPress security best practices.
 * Version:      0.1.0
 * Requires PHP: 7.2
 * Author:       Cyan Lovers <hello@cyanlove.com>
 * Author URI:   https://cyanlove.com/
 * Text Domain:  cyanlove-security
 * Domain Path:  /languages
 * License:      MIT
 * License URI:  https://opensource.org/licenses/MIT
 */

namespace CyanLove\Security;
